                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" aria-describedby="example1_info">
                                            ...
                                            <?php foreach ($transaksi as $row) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['alamat']; ?></td>
                                                    <td>
                                                        <form action="/konfirmasi/<?= $row['id_transaksi']; ?>" method="Post"><small><?= $row['keterangan']; ?></small><br>
                                                            <select name="st" id="st">
                                                                <option value="1">Menunggu Pembayaran</option>
                                                                <option value="2">Barang Dikemas</option>
                                                                <option value="3">Barang Dikirim</option>
                                                            </select>


                                                            <!-- <input type="number" name="st" value="<?= $row['id_status']; ?>"> -->
                                                            <input type="hidden" name="tr" value="<?= $row['id_transaksi']; ?>">
